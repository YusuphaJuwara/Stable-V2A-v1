...
from main.data.dataset_wtm import WalkingTheMapsDataset

############################################################################
# DATA MODULE
##############################################################################

class WalkingTheMaps(pl.LightningDataModule):
    def __init__(
        self,
        root_dir: str,
    ...
    def setup(self, stage: str) -> None:
        if stage == "fit" or stage == "validate":
            self.train_dataset = WalkingTheMapsDataset(
            ...
            self.val_dataset = WalkingTheMapsDataset(
                root_dir=self.root_dir,
        ...
        if stage == "test":
            self.test_dataset = WalkingTheMapsDataset(
                root_dir=self.root_dir,
